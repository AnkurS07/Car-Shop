...
public class Client extends UserRole
{
  ...
  public boolean addAppointment(Appointment aAppointment)
  {
    ...
    Client existingClient = aAppointment.getClient();
    boolean isNewClient = existingClient != null && !this.equals(existingClient);
    if (isNewClient)
    {
      aAppointment.setClient(this);
    }
    else
    {
  ...
  public boolean removeAppointment(Appointment aAppointment)
  {
    ...
    //Unable to remove aAppointment, as it must always have a client
    if (!this.equals(aAppointment.getClient()))
    {
